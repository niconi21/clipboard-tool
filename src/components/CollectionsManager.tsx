...
export function CollectionsManager({ collections, counts, onCreate, onUpdate, onDelete }: Props) {
  ...
  return (
    <div className="space-y-3">
      ...
      {collections.map((col) => (
        <div key={col.id} className="flex items-center gap-3 p-3 rounded-lg bg-surface border border-stroke">
          {editingId === col.id ? (
            <>
            ...
            <>
              ...
              <span className="flex-1 text-sm text-content truncate">{col.name}</span>
